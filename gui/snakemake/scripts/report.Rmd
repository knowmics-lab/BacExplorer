...
#for Rstudio testing
# path_output <- "/Users/adria/Desktop/Uni/Magistrale/Tirocinio/test/output"
# identity <- 90
# coverage <- 90
# type <- "Fasta"
...
```{r Plasmids, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
  ...
  if(nrow(plfd_tab) != 0) {
    ...
    writeData(wbp, sheet = "Plasmidfinder", plfd_tab)
...
```{r fimtyper, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
  ...
  fim_tab <- as.data.frame(do.call(rbind, lapply(fim, fim_function)))
...
```{r ClermonTyping, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
  ...
  cle_tab <- as.data.frame(do.call(rbind, lapply(clermontyping, clermontyping_function)))
...
```{r sccmec, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
  ...
  if(dim(stap_tab)[1] != 0){
    ...
    writeData(wbstaph, sheet = "sscmec", st_tab)
  }
```
