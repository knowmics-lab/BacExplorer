...
#for Rstudio testing
# path_output <- normalizePath("//wsl.localhost/Ubuntu/home/adriana/analisi_bacExplorer/fastq_test/output", winslash = "/", mustWork = TRUE)
...
args=commandArgs(trailingOnly = TRUE)
  ...
  quast <- list.files(path=paste0(path_output, "/quality_assessment/quast_results/16Can_S5_L001"), pattern="_report.tsv", full.names=TRUE, recursive=TRUE)
