...
#for Rstudio testing
# path_output <- "/Users/gretu/Documents/Batteri_Dafne/Gennaio25/output/"
# identity <- 90
# coverage <- 90
...
args=commandArgs(trailingOnly = TRUE)
try({
  #Per ora path assoluti, poi path_output
...
```{r NCBI_antibiotic_resistance, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
...
### AMRfinder plus
```{r AMRfinder_plot, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.align='center'}
 try({
...
### NCBI
```{r ncbi_plot, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
try({ 
abricate_ncbi <- list.files(path=paste0(path_output, "/abricate/"), pattern = "ncbi", full.names=TRUE, recursive=TRUE)
...
```{r Megares_plot, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
try({ 
abricate_mega <- list.files(path=paste0(path_output, "/abricate/"), pattern = "megares", full.names=TRUE, recursive=TRUE)
...
```{r resfinder_plot, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
try({
abricate_resfinder <- list.files(path=paste0(path_output, "/abricate/"), pattern = "resfinder", full.names=TRUE, recursive=TRUE)
...
```{r CARD_plot, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
try({
abricate_card <- list.files(path=paste0(path_output, "/abricate/"), pattern = "card", full.names=TRUE, recursive=TRUE)
...
```{r arg-annot_plot, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
try({
...
```{r vfdb_plot, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
try({
abricate_vfdb <- list.files(path=paste0(path_output, "/abricate/"), pattern = "vfdb", full.names=TRUE, recursive=TRUE)
...
```{r virulencefinder_plot, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.align='center'}
try({
virulencefinder <- list.files(path=paste0(path_output, "/virulencefinder/"), pattern = "results_tab.tsv", full.names=TRUE, recursive=TRUE)
