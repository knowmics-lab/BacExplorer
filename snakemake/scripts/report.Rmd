...
![](/home/adriana/bacExplorer/BacExplorer/snakemake/scripts/logo.png)
...
```{r fastqc, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
  ...
  try({
    fastqc <- list.files(path=paste0(path_output, "/fastqc/"), pattern="_data", full.names=TRUE, recursive=TRUE)
...
```{r quast, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
  ...
  try({
    quast <- list.files(path=paste0(path_output, "/quast_results/"), pattern="_report.tsv", full.names=TRUE, recursive=TRUE)
