...
#for Rstudio testing
#path_output <- "/Users/adria/Desktop/Uni/BacExplorer_prove/Prova1/output"
#identity <- 90
#coverage <- 90
#type <- "Fasta"
...
```{r fastqc, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
  ...
  try({
    ...
    fq_tab <- as.data.frame(do.call(rbind, lapply(fastqc, fastqc_function)))
...
| ShigEiFinder v.1.3.5 | [X Zhang et al., 2021](https://doi.org/10.1099/mgen.0.000704) |
| meningotype v.0.8.5 | [JC Kwong et al.](https://github.com/MDU-PHL/meningotype) |
| ngmaster v.0.5.8 | [JC Kwong et al., 2016](https://doi.org/10.1099/mgen.0.000076) |
| pasty v.2.2.1 | [RA Petit III](https://github.com/rpetit3/pasty?tab=readme-ov-file) |